...
* Visualize the standardized price series for those with unit changes: use 2015 average as basis
* add note on the missing time periods for those with missing times
